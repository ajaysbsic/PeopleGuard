    ...
    public partial class AddAuditLogsTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvestigationRemarks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvestigationRemarks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvestigationRemarks_Investigations_InvestigationId",
                        column: x => x.InvestigationId,
                        principalTable: "Investigations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LetterContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PdfPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IssuedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarningLetters", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_Department_Factory",
                table: "Employees",
                columns: new[] { "Department", "Factory" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestigationRemarks_InvestigationId",
                table: "InvestigationRemarks",
                column: "InvestigationId");

            migrationBuilder.CreateIndex(
                name: "IX_InvestigationRemarks_UserId",
                table: "InvestigationRemarks",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Investigations_EmployeeId",
                table: "Investigations",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Investigations_IsDeleted",
                table: "Investigations",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarningLetters_EmployeeId",
